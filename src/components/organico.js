 ...
 son completamente libres de pesticidas y otros productos químicos
  ...
  sostenibles que minimizan el impacto ambiental.</p>
      ...
      <div className='organico-item reverse'>
        ...
        <p className= "parrafo" data-aos="fade-right" >En Limon Supremo, cada paso del proceso de cultivo se lleva a cabo con el más alto estándar de excelencia. Desde la selección de semillas hasta la cosecha, nos comprometemos a ofrecer limones que no solo cumplen con los requisitos orgánicos, sino que también son una fuente de bienestar para la salud. Nuestros limones, al ser libres de pesticidas, aseguran que los consumidores disfruten de una fruta fresca y natural, con un sabor auténtico y beneficios nutricionales sin compromisos.</p>
      </div>
    </div>
  );
}
